    ...
    return (
      <div>   
        ...
        <div className="flex-grid">
          <div className="grid-item-key"><img className="icon" src="/public/images/mntn-sunny.png"/><img className="icon" src="/public/images/mntn-not-sunny.png"/></div>
        ...
        <div className="flex-grid">
          <div className="grid-item-key"><img className="icon" src="/public/images/mntn-bagged-sunny.png"/><img className="icon" src="/public/images/mntn-bagged.png"/></div>
          <div className="grid-item-key">- Bagged (Sunny/Not Sunny)</div>
          <div className="grid-item-key"><img className="icon" src="/public/images/mntn-not-bagged-sunny.png"/><img className="icon" src="/public/images/mntn-not-bagged.png"/></div>
